...
export class AdminComponent extends React.Component {
  ...
  onSubmit(e){
    ...
    this.presalePoolSettings.setSettings(Web3Utils.toWei(this.poolValues.maxAllocation), Web3Utils.toWei(this.poolValues.maxPerContributor), Web3Utils.toWei(this.poolValues.minPerContributor), this.poolValues.feePercentage);
    ...
    return (
      <div className="container container_bg">
        ...
        <div>
         ...
         <Form>
         <div>
              <p className="send-info-amount">{this.poolValues.status} </p>
              <div form-inline-i form-inline-i_token-address>
               <Button className="button" onClick={this.onClose}>Close</Button>
               <Button className="button" onClick={this.onTransfer}>Set Transfered</Button>
              </div>
         </div>
         </Form>
        </div>
